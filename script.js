$(document).ready(function(){
    ...
    document.getElementById("myButton").onclick = function () {
        location.href = "https://github.com/vaibhav702/Project---Books-ManagementGroup7.git";
    };
    document.getElementById("bwButton").onclick = function () {
        location.href = "https://github.com/vaibhav702/Project-Blogging-website.git";
    };
    document.getElementById("ciButton").onclick = function () {
        location.href = "https://github.com/vaibhav702/project-internshipGroup73.git";
    };
    ...
    var typed = new Typed(".typing", {
        strings: [ "Software Developer", "Backend Developer","Node.js developer"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
